...
class PermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $modules = [
            ...
            ['name' => 'blog', 'label' => 'Blog', 'module' => 'blog'],
            ['name' => 'ads', 'label' => 'Módulo Ads', 'module' => 'ads'],
            ['name' => 'automatizaciones', 'label' => 'Automatizaciones', 'module' => 'automatizaciones'],
            ['name' => 'conversiones', 'label' => 'Conversiones', 'module' => 'conversiones'],
            ['name' => 'reportes', 'label' => 'Reportes', 'module' => 'reportes'],
            ['name' => 'propuestas', 'label' => 'Propuestas', 'module' => 'propuestas'],
            ...
            ['name' => 'webhooks', 'label' => 'Webhooks', 'module' => 'webhooks'],
