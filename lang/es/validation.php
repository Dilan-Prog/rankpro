...
|--------------------------------------------------------------------------
|
| El proyecto no tenía archivos de traducción. Al cambiar 'locale' y
| 'fallback_locale' a 'es' en config/app.php, el traductor dejaría de
| encontrar los mensajes de validación del framework (que vienen en inglés)
| y devolvería la clave cruda, p. ej. "validation.required".
|
| Este archivo cubre las reglas que realmente usa la aplicación y las más
| habituales, para que ningún formulario muestre claves sin traducir.
|
*/
