...
@section('content')
    <div class="page-header">
        <div>
            <h1 class="page-header__title">Editar Proyecto</h1>
            <p class="page-header__subtitle">{{ $proyecto->nombre }}</p>
        </div>
    ...
    <div class="card card--padded form-card">
        <form method="POST" action="{{ route('admin.desarrollo.update', $proyecto) }}">
            @csrf
            @method('PUT')
            @include('admin.desarrollo._form')
